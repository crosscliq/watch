...
class LocatorModelTools extends LocatorModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'locator'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh)) 
		{
		    ...
		    {
		        $item->link = 'index.php?option=com_locator&view=tools&task=view&id='.$item->id;
		    }		    
		} 
