...
class JFakeElementMediamanagerAdvertisers extends JFakeElementBase
{
	var	$_name = 'MediamanagerAdvertisers';
...
if(version_compare(JVERSION,'1.6.0','ge')) {
	class JFormFieldMediamanagerAdvertisers extends JFakeElementMediamanagerAdvertisers {}
} else {
	class JElementMediamanagerAdvertisers extends JFakeElementMediamanagerAdvertisers {}
}
?>