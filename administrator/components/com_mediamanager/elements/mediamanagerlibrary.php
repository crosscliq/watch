...
class JFakeElementMediamanagerLibrary extends JFakeElementBase
{
	var	$_name = 'MediamanagerLibrary';
	...
	public function getInput() 
	{
		...
		$model = JModel::getInstance( 'ElementLibrary', 'MediamanagerModel' );
...
if(version_compare(JVERSION,'1.6.0','ge')) {
	class JFormFieldMediamanagerLibrary extends JFakeElementMediamanagerLibrary {}
} else {
	class JElementMediamanagerLibrary extends JFakeElementMediamanagerLibrary {}
}
?>