    ...
    <table class="adminlist" style="clear: both;">
        <thead>
            <tr>
                ...
                <th style="width: 50px;">
                    <?php echo DSCGrid::sort( 'ID', "tbl.categorytype_id", @$state->direction, @$state->order ); ?>
                </th>
                <th style="text-align: left;">
                    <?php echo DSCGrid::sort( 'Title', "tbl.categorytype_title", @$state->direction, @$state->order ); ?>
                </th>
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
                ...
                <td style="text-align: center;">
                    <?php echo DSCGrid::checkedout( $item, $i, 'categorytype_id' ); ?>
                </td>
                <td style="text-align: center;">
                    <a href="<?php echo $item->link; ?>">
                        <?php echo $item->categorytype_id; ?>
                    </a>
                </td>
                <td style="text-align: left;">
                    <a href="<?php echo $item->link; ?>">
                        <?php echo $item->categorytype_title; ?>
                    </a>
                </td>
				<td style="text-align: center;">
					<?php echo DSCGrid::order( $item->categorytype_id ); ?>
					<?php echo DSCGrid::ordering( $item->categorytype_id, $item->ordering ); ?>
				</td>
            </tr>
            <?php $i=$i+1; $k = (1 - $k); ?>
            <?php endforeach; ?>
