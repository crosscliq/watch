        ...
        <thead>
            <tr>
                ...
                <th style="text-align: left;">
                    <?php echo DSCGrid::sort( 'Title', "tbl.category_title", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 150px;">
                    <?php echo DSCGrid::sort( 'Type', "tbl.categorytype_id", @$state->direction, @$state->order ); ?>
                </th>
            </tr>
            <tr class="filterline">
                <th colspan="3">
                ...
                <th style="text-align: center;">
                    <?php echo MediaManagerSelect::categorytype( @$state->filter_categorytype, 'filter_categorytype', $attribs, 'filter_categorytype', true ); ?>
                </th>
            </tr>
            <tr>
