    ...
    <table class="adminlist" style="clear: both;">
        <thead>
            <tr>
                ...
                <th style="width: 50px;">
                    <?php echo DSCGrid::sort( 'ID', "tbl.library_id", @$state->direction, @$state->order ); ?>
                </th>
                <th style="text-align: left;">
                    <?php echo DSCGrid::sort( 'Title', "tbl.library_title", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
                    <?php echo DSCGrid::sort( 'Enabled', "tbl.library_enabled", @$state->direction, @$state->order ); ?>
                </th>
            </tr>
            <tr class="filterline">
                <th colspan="3">
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
                ...
                <td style="text-align: center;">
                    <?php echo DSCGrid::checkedout( $item, $i, 'library_id' ); ?>
                </td>
                <td style="text-align: center;">
                    <a href="<?php echo $item->link; ?>">
                        <?php echo $item->library_id; ?>
                    </a>
                </td>
                <td style="text-align: left;">
                    <a href="<?php echo $item->link; ?>">
                        <?php echo $item->library_title; ?>
                    </a>
                </td>
                <td style="text-align: center;">
                    <?php echo DSCGrid::enable($item->library_enabled, $i, 'library_enabled.' ); ?>
                    <?php // echo JHTML::_('grid.access',   $item, $i, $item->access); ?>
                </td>
            </tr>
            <?php $i=$i+1; $k = (1 - $k); ?>
            <?php endforeach; ?>
