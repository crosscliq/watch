    ...
    <table class="adminlist" style="clear: both;">
        <thead>
            <tr>
                ...
                <th style="width: 50px;">
                    <?php echo DSCGrid::sort( 'ID', "tbl.station_id", @$state->direction, @$state->order ); ?>
                </th>
                <th style="text-align: left;">
                    <?php echo DSCGrid::sort( 'Title', "tbl.station_title", @$state->direction, @$state->order ); ?>
                </th>
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
                ...
                <td style="text-align: center;">
                    <?php echo DSCGrid::checkedout( $item, $i, 'station_id' ); ?>
                </td>
                <td style="text-align: center;">
