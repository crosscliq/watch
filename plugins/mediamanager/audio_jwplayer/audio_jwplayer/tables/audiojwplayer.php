...
class MediaManagerTableAudioJwplayer extends DSCTable 
{ 
	function MediaManagerTableAudioJwplayer( &$db ) 
	{
        $keynames = array(); 
        $keynames['audiojwplayer_id'] = 'audiojwplayer_id'; 
        $keynames['media_id'] = 'media_id';
        $this->setKeyNames($keynames);
        
		$tbl_key 	= 'audiojwplayer_id';
		$tbl_suffix = 'audio_jwplayer';
