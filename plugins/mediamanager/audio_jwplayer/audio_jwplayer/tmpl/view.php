...
<div id="<?php echo $div_id; ?>-wrap" class="audio audio_jwplayer">
...
<?php if (!empty($vars->db_files)) { ?>
    ...
    <script type="text/javascript">
      jwplayer('<?php echo $div_id; ?>').setup({
        ...
        'controlbar': '<?php echo $vars->row->params->get( 'audiojwplayer_controlbar_position', 'over' ); ?>',
        'autostart': '<?php echo $vars->row->params->get( 'audiojwplayer_auto_play', '0' ) ? 'true' : 'false'; ?>',
        'icons': '<?php echo $vars->row->params->get( 'audiojwplayer_show_icons', '1' ) ? 'true' : 'false'; ?>',
        'bufferlength': '<?php echo $vars->row->params->get( 'audiojwplayer_buffer_length', '1' ); ?>',
        'repeat': 'list',
        'modes': [
            {type: 'html5'},
        ...
        events: {
            onBeforePlay: function() {
                ...
                jQuery('.audio_jwplayer object').each(function(){
                    element = jQuery(this);
