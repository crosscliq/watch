<?php defined('_JEXEC') or die('Restricted access'); ?>
    ...
    <tbody> 
        ...
        <tr>
            ...
            <td style="text-align: center;">
                <input type="button" onclick="AudioJwplayer.deleteFile( '<?php echo $item->mediafile_id; ?>', 'form_files', '<?php echo JText::_( "COM_MEDIAMANAGER_DELETING" ); ?>' );" value="<?php echo JText::_( "COM_MEDIAMANAGER_DELETE" ); ?>" >
            </td>
            <td style="text-align: center;">
