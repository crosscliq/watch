...
class MediaManagerTableSlideshowKiosk extends DSCTable 
{ 
	function MediaManagerTableSlideshowKiosk( &$db ) 
	{
        $keynames = array(); 
        $keynames['slideshowkiosk_id'] = 'slideshowkiosk_id'; 
        $keynames['media_id'] = 'media_id';
        $this->setKeyNames($keynames);
        
		$tbl_key 	= 'slideshowkiosk_id';
		$tbl_suffix = 'slideshow_kiosk';
