...
class MediaManagerTableVideoJplayer extends DSCTable 
{ 
	function MediaManagerTableVideoJplayer( &$db ) 
	{
        $keynames = array(); 
        $keynames['videojplayer_id'] = 'videojplayer_id'; 
        $keynames['media_id'] = 'media_id';
        $this->setKeyNames($keynames);
        
		$tbl_key 	= 'videojplayer_id';
		$tbl_suffix = 'video_jplayer';
