...
class MediaManagerSelectVideoJplayer extends MediaManagerSelect
{
    public static function url_target( $selected, $name = 'videojplayer_url_target', $attribs = array('class' => 'inputbox', 'size' => '1'), $idtag = null, $allowAny = false, $title = 'Select URL Target' )
    {
        $lists = array();
    ...
    public static function controlbar_position( $selected, $name = 'videojplayer_controlbar_position', $attribs = array('class' => 'inputbox', 'size' => '1'), $idtag = null, $allowAny = false, $title = 'Select Position' )
    {
        $lists = array();
