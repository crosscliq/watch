...
class plgMediaManagerSlideshow_Default extends MediaManagerPluginBase
{
	public $_element = 'slideshow_default';	
	public $dot_path_prefix = 'slideshow_default.';
	public $path_prefix = 'slideshow_default/';
	public $plain_name = 'SlideshowDefault';
	public $full_path = '';
	public $relative_path = '';
	
	function plgMediaManagerSlideshow_Default( &$subject, $config )
	{
    ...
    public function onEditMedia( $plugin, $media_item )
    {
        ...
        MediaManager::load( 'MediaManagerSelect' . $this->plain_name, $this->dot_path_prefix . 'slideshow_default.library.select', array( 'site'=>'site', 'type'=>'plugins', 'ext'=>'mediamanager' ) );
        ...
        foreach ($gallery_images as $image)
        {
            if (!in_array($image, $filenames_from_db))
            {
                ...
                if ($file->save())
                {
                    ...
                    if ($mediafile->save())
                    {
                        // and create the corresponding row in the slideshow_default table
