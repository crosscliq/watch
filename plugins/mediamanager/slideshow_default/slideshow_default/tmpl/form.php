    ...
    <div class="dsc-table">
        <div class="dsc-row">
            ...
            <div class="dsc-cell dsc-value">
                ...
                <?php if (!empty($row->media_id)) { ?>
                    <input name="add_new_file_local" type="button" onclick="document.adminForm.add_type.value='add_new_file_local'; SlideshowDefault.addNewFile( 'form_files', '<?php echo JText::_( "COM_MEDIAMANAGER_ADDING_FILE" ); ?>' );" value="<?php echo JText::_( "COM_MEDIAMANAGER_ADD_NEW_LOCAL_FILE" ); ?>" />
                <?php } else { ?>
        ...
        <div class="dsc-row">
            ...
            <div class="dsc-cell dsc-value">
      		    ...
      		    <?php if (!empty($row->media_id)) { ?>
                    <input name="add_new_file" type="button" onclick="document.adminForm.add_type.value='add_new_file'; SlideshowDefault.addNewFile( 'form_files', '<?php echo JText::_( "COM_MEDIAMANAGER_ADDING_FILE" ); ?>' );" value="<?php echo JText::_( "COM_MEDIAMANAGER_ADD_NEW_REMOTE_FILE" ); ?>" />
                <?php } else { ?>
                    <p class="dsc-tip dsc-clear">
            ...
            <div class="dsc-cell dsc-value">
    		    <?php if (!empty($row->media_id)) { ?>
    				...
    				?>
          		    ...
          		    <input name="add_existing_file" type="button" onclick="document.adminForm.add_type.value='add_existing_file'; SlideshowDefault.addNewFile( 'form_files', '<?php echo JText::_( "COM_MEDIAMANAGER_ADDING_FILE" ); ?>' );" value="<?php echo JText::_( "COM_MEDIAMANAGER_ADD_EXISTING_FILE" ); ?>" />
