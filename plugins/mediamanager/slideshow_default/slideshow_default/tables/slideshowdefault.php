...
class MediaManagerTableSlideshowDefault extends DSCTable 
{ 
	function MediaManagerTableSlideshowDefault( &$db ) 
	{
        $keynames = array(); 
        $keynames['slideshowdefault_id'] = 'slideshowdefault_id'; 
        $keynames['media_id'] = 'media_id';
        $this->setKeyNames($keynames);
        
		$tbl_key 	= 'slideshowdefault_id';
		$tbl_suffix = 'slideshow_default';
