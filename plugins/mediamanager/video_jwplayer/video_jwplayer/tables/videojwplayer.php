...
class MediaManagerTableVideoJwplayer extends DSCTable 
{ 
	function MediaManagerTableVideoJwplayer( &$db ) 
	{
        $keynames = array(); 
        $keynames['videojwplayer_id'] = 'videojwplayer_id'; 
        $keynames['media_id'] = 'media_id';
        $this->setKeyNames($keynames);
        
		$tbl_key 	= 'videojwplayer_id';
		$tbl_suffix = 'video_jwplayer';
