...
class MediaManagerSelectVideoJwplayer extends MediaManagerSelect
{
    public static function url_target( $selected, $name = 'videojwplayer_url_target', $attribs = array('class' => 'inputbox', 'size' => '1'), $idtag = null, $allowAny = false, $title = 'Select URL Target' )
    {
        $lists = array();
    ...
    public static function controlbar_position( $selected, $name = 'videojwplayer_controlbar_position', $attribs = array('class' => 'inputbox', 'size' => '1'), $idtag = null, $allowAny = false, $title = 'Select Position' )
    {
        $lists = array();
