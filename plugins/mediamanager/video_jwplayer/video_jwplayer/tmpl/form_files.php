<?php defined('_JEXEC') or die('Restricted access'); ?>
    ...
    <tbody> 
        ...
        <tr>
                    ...
                    <div class="dsc-row">
                        ...
                        <div class="dsc-cell">
                            <?php if (!empty($item->file_url)) {
                                ...
                                echo $item->file_path . DS . $item->file_name;
                            } ?>
                        </div>
                    </div>
                    <div class="dsc-row">
            ...
            <td style="text-align: center;">
                <input type="button" onclick="VideoJwplayer.deleteFile( '<?php echo $item->mediafile_id; ?>', 'form_files', '<?php echo JText::_( "COM_MEDIAMANAGER_DELETING" ); ?>' );" value="<?php echo JText::_( "COM_MEDIAMANAGER_DELETE" ); ?>" >
            </td>
            <td style="text-align: center;">
