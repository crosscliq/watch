<?php defined('_JEXEC') or die('Restricted access'); ?>
    ...
    <tbody> 
        ...
        <tr>
            ...
            <td style="text-align: center;">
                <?php echo MediaManagerSelectSlideshowPikachoose::url_target( $item->url_target, 'url_target['.$item->mediafile_id.']' );?>
            </td>
            <td style="text-align: center;">
            ...
            <td style="text-align: center;">
                <input type="button" onclick="SlideshowPikachoose.deleteFile( '<?php echo $item->mediafile_id; ?>', 'form_files', '<?php echo JText::_( "COM_MEDIAMANAGER_DELETING" ); ?>' );" value="<?php echo JText::_( "COM_MEDIAMANAGER_DELETE" ); ?>" >
            </td>
            <td style="text-align: center;">
