...
class MediaManagerTableSlideshowPikachoose extends DSCTable 
{ 
	function MediaManagerTableSlideshowPikachoose( &$db ) 
	{
        $keynames = array(); 
        $keynames['slideshowpikachoose_id'] = 'slideshowpikachoose_id'; 
        $keynames['media_id'] = 'media_id';
        $this->setKeyNames($keynames);
        
		$tbl_key 	= 'slideshowpikachoose_id';
		$tbl_suffix = 'slideshow_pikachoose';
    ...
    function check()
    {
        ...
        $this->caption = $helper->truncateString( $this->caption, '300' );
